...
pub use repository::{detect_repo, format_remote_url, refresh_repo, switch_branch, create_branch, delete_branch, get_origin_url, get_remote_url, parse_git_url, RemoteInfo, RepoInfo};
